...
- Password at least 8 characters long with upper and lower case letters and at least one number
...
9. You should see your organization's letterhead at the top.
   > > > > > > > satp04-mom/typos
10. Please read the email and select the link "Complete Registration To CertGround™".
11. The link will re-direct you to the login page if and when successful.
12. Please enter your email address and password to login to CertGround™.
13. You will be taken to the <a href="/docs/member/member-profile">Member Profile</a> page.
